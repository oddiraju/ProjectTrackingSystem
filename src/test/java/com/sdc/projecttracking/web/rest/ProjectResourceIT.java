...
import com.sdc.projecttracking.repository.ProjectRepository;
...
public class ProjectResourceIT {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getProjectDetails()).isEqualTo(DEFAULT_PROJECT_DETAILS);
    }
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].projectDetails").value(hasItem(DEFAULT_PROJECT_DETAILS)));
    }
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.projectDetails").value(DEFAULT_PROJECT_DETAILS));
    }
    @Test
    @Transactional
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getProjectDetails()).isEqualTo(UPDATED_PROJECT_DETAILS);
    }
