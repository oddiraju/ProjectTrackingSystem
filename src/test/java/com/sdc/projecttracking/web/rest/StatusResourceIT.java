...
public class StatusResourceIT {
    ...
    private static final String DEFAULT_DELIVERABLE = "AAAAAAAAAA";
    private static final String UPDATED_DELIVERABLE = "BBBBBBBBBB";
    ...
    public void createStatus() throws Exception {
        ...
        assertThat(testStatus.getDeliverable()).isEqualTo(DEFAULT_DELIVERABLE);
    ...
    @Test
    @Transactional
    public void checkDeliverableIsRequired() throws Exception {
        int databaseSizeBeforeTest = statusRepository.findAll().size();
        // set the field null
        status.setDeliverable(null);
    ...
    public void getAllStatuses() throws Exception {
        ...
        restStatusMockMvc.perform(get("/api/statuses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].deliverable").value(hasItem(DEFAULT_DELIVERABLE)))
    ...
    public void getStatus() throws Exception {
        ...
        restStatusMockMvc.perform(get("/api/statuses/{id}", status.getId()))
            ...
            .andExpect(jsonPath("$.deliverable").value(DEFAULT_DELIVERABLE))
    ...
    public void updateStatus() throws Exception {
        ...
        Status testStatus = statusList.get(statusList.size() - 1);
        assertThat(testStatus.getDeliverable()).isEqualTo(UPDATED_DELIVERABLE);
