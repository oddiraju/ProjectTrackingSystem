...
import com.sdc.projecttracking.domain.Status;
import com.sdc.projecttracking.repository.StatusRepository;
...
/**
 * REST controller for managing {@link com.sdc.projecttracking.domain.Status}.
 */
@RestController
@RequestMapping("/api")
@Transactional
